...
<head>
    ...
    .nav-bar-list {
        display: grid;
        grid-template-columns: 40px auto auto auto auto auto;
        ...
        <ul class="nav-bar-list" id="nav-bar-dropdown">
            ...
            <li id="dropdownSelect2" class="nav-item">
                ...
                <ul id="dropdown2" class="dropdown-list">
                    <a href="https://www.nysmesonet.org/" class="dropdown-link">
                        <li class="dropdown-item">
                            <p class="dropdown-text">NYS Mesonet</p>
                        </li>
                    </a>
                    ...
                    <a href="https://weatheranalytics.org/" class="dropdown-link">
                        <li class="dropdown-item">
                            <p class="dropdown-text">Center of Excellence</p>
                        </li>
                    </a>
            ...
            <li id="dropdownSelect3" class="nav-item">
                ...
                <ul id="dropdown3" class="dropdown-list">
                    ...
                    <a href="https://www.atmos.albany.edu/index.php?d=contest_ext" class="dropdown-link">
                        <li class="dropdown-item">
                            <p class="dropdown-text">Albany Extended Forecast Contest</p>
                        </li>
                    </a>
            ...
            <li id="dropdownSelect4" class="nav-item">
                <div class="nav-item-select">
                    <p class="nav-item-text">Placeholder</p>
                </div>
        ...
        <li class="inner-list-1">
            ...
            <ul class="text-container">
                ...
                <li class="text-item">
                    ...
                    <p class="pres-data" style="font-weight: bolder;" id="presHg"></p>
                </li>
                <li class="text-item">
                    <br>
...
<script>
//Make the dropdown drop down
const dropdownSelect = document.getElementById("nav-bar-dropdown");
const dropdown = document.querySelectorAll(".dropdown-list"); // Assuming there's only one dropdown, which there is

// Add event listener to the dropdownSelect
dropdownSelect.addEventListener("mouseenter", function() {
  // Add the "show" class to all dropdowns to expand them simultaneously
...
dropdownSelect.addEventListener("mouseleave", function() {
  // Remove the "show" class from all dropdowns to collapse them simultaneously
  dropdown.forEach(function(dropdown) {
...
function myFunction2() {
    console.log("Page NOT scrolled down!");
